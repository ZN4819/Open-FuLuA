...
TRUSTED_ASSET_HASHES_SHA256 = "09a63e0035c06a8aff70494052651855022bb4d1857e549b393dbd9ae682e44e"
...
class ReportTemplateRegistry:
    ...
    def _validate_runtime_contract(runtime: bytes, manifest: dict[str, Any], slots: list[str]) -> None:
        ...
        if set(expected_semantic) != slot_semantic or len(expected_semantic) != 13 or any(tag_values.count(tag) != count for tag, count in expected_semantic.items()):
